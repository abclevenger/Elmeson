...
const nextConfig: NextConfig = {
  ...
  async headers() {
    return [
        ...
        headers: [
          ...
          { key: "Cross-Origin-Opener-Policy", value: "same-origin" },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://www.google-analytics.com https://www.googletagmanager.com https://*.supabase.co wss://*.supabase.co https://api.sunrise-sunset.org",
      ...
      {
        source: "/sunset-from-el-meson-2048x1087.png",
        headers: [
          { key: "Cache-Control", value: "public, max-age=31536000, immutable" },
        ],
      },
